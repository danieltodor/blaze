...
PS0='$(_blaze_save_start_time)' # Is expanded after a command is read and before the command is executed
PROMPT_COMMAND='$(_blaze_save_exit_status)' # Executed before the printing of each primary prompt
